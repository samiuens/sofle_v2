...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FIRST] = LAYOUT(
        ...
        KC_TRNS, KC_EQL, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, KC_TRNS, KC_TRNS, KC_LBRC, KC_RBRC, KC_SCLN, KC_COLN, KC_BSLS,
                KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(3), KC_TRNS, KC_TRNS, KC_TRNS
    ),
    [SECOND] = LAYOUT(
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS, LSFT(LCMD(KC_1)), LSFT(LCMD(KC_2)), LSFT(LCMD(KC_3)), LSFT(LCMD(KC_4)), LSFT(LCMD(KC_5)), LSFT(LCMD(KC_6)), LSFT(LCMD(KC_7)), LSFT(LCMD(KC_8)), LSFT(LCMD(KC_9)), KC_NO, KC_BSPC,
        KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_NO, KC_NO,
        KC_TRNS, LSFT(LALT(LCMD(KC_1))), LSFT(LALT(LCMD(KC_2))), LSFT(LALT(LCMD(KC_3))), LSFT(LALT(LCMD(KC_4))), LSFT(LALT(LCMD(KC_5))), KC_TRNS, KC_TRNS, LSFT(LALT(LCMD(KC_6))), LSFT(LALT(LCMD(KC_7))), LSFT(LALT(LCMD(KC_8))), LSFT(LALT(LCMD(KC_9))), KC_NO, KC_TRNS, 
